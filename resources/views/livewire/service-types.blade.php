...
<div class="mx-auto px-14 py-16 mb-8" >
    <h3 class="text-center font-bold text-2xl py-6 text-green-700">Services We Provide</h3>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 py-4">
        @foreach($serviceTypes as $serviceType)
        <div class="bg-white shadow-md rounded-lg overflow-hidden hover:border border-green-500 transition duration-300">
