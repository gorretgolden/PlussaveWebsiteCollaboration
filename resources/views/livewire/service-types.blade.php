...
<div class="bg-gray-100 px-4 sm:px-10 lg:px-20 py-16 mb-8">
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ url('/services/' . $serviceType->route) }}">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:border border-green-700 transition duration-300 w-full">
